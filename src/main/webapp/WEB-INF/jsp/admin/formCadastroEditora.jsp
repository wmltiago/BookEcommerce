			...
			<div class="container">
				...
				<div class="card bg-light">
					<article class="card-body mx-auto" style="max-width: 400px;">
						<h4 class="card-title mt-3 text-center">Cadastro de Editora</h4>
						<br />
						<form:form action="${s:mvcUrl('EC#cadastrarEditora').build()}"
							...
							<div class="form-group input-group">
								...
								<form:input path="nomeEditora" type="text" class="form-control"
...
<!-- 							</div> -->
							...
							<!-- form-group// -->
							<p class="text-center">
								<a href="http://localhost:8080/admin/listarEditoras">Ir para listagem de Editoras</a>
							</p>
						</form:form>
					</article>
				</div>
