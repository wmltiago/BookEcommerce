                ...
                <div class="container">
                    ...
                    <div class="row border border-default">
                        ...
                        <div class="bg-primary text-center p-2 col-md-12">
                            <p class="lead text-white">LISTAGEM DE EDITORAS</p>
                        </div>
                  	  ...
                  	  <c:forEach items="${listaEditoras}" var="ed">
	                        ...
	                        <div class="py-2 odd col-3 text-center">
	                        <p><a href="${s:mvcUrl('EC#editarEditora').arg(0, ed.idEditora).build()}">Editar <i class="bi bi-pencil-fill"></i>
	                        </a>|
	                        <c:if test = "${ed.ativoEditora == true}">
	                         <a style='color:red' href="${s:mvcUrl('EC#inativarEditora').arg(0, ed.idEditora).build()}">Inativar <i class="fas fa-toggle-off"></i></a>
	                        </c:if>
	                        <c:if test = "${ed.ativoEditora == false}">
	                          <a href="${s:mvcUrl('EC#ativarEditora').arg(0, ed.idEditora).build()}">Ativar <i class="fas fa-toggle-on"></i></a>
	                         </c:if>
	                          </p>
	                        </div>
						</c:forEach>
                     ...
                     <p class="text-center"> <a href="http://localhost:8080/admin/cadastroEditora">Ir para cadastro de Editora</a> </p> 
                    </div> 
                    <!--container end.//-->
                </br></br>
            </div> <!-- ate aqui-->
